(function(){
		...
		if(flippedCards.length < 2){
			...
			if(flippedCards.length === 2){
				...
				if(flippedCards[0].childNodes[3].id === flippedCards[1].childNodes[3].id){
					...
					//chama a função que exibe a mensagem Well Played
					matchCardsSign();
	...
	//função que gera o sinal de Well Played
	function matchCardsSign(){
		//joga a mensagem de Well played para o primeiro plano
		...
		setTimeout(function(){
			//joga a mensagem de Well played para o plano de fundo
			matchSign.style.zIndex = "-1";
	...
	}//fim da função que exibe mensagem de Well played
